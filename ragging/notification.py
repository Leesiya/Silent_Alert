...
if __name__ == '__main__':
    ...
    while cap.isOpened():
        ...
        try:
            ...
            print(SpelledWord)
            if SpelledWord == 'EMERGENCY!  Student call':

                fromaddr = "leesiya.lee.293@gmail.com"
                toaddr = "leesiya.lee.293@gmail.com"
                ...
                # storing the subject
                msg[
                    'Subject'] = " STUDENT SAFETY CALL "

                # attach the body with the msg instance
                msg.attach(MIMEText('STUDENT SAFETY CALL'))
                ...
                # Authentication
                s.login(fromaddr, "siug kupt hmdz mdrk")
